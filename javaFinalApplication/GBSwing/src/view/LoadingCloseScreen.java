 ...
 * @author LUCA
 */
public class LoadingCloseScreen extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Cerrando Sesión - Gestión de Biblioteca");
        setUndecorated(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoadingCloseScreen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LoadingCloseScreen().setVisible(true);
            }
        });
    }
