 ...
 * @author luca_
 */
public class DangerAlert extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Error en la Operación - Gestión de Biblioteca");
        setUndecorated(true);

        jPanel1.setBackground(new java.awt.Color(255, 0, 0));

        rSLabelTextIcon2.setBackground(new java.awt.Color(255, 0, 0));
        ...
        rSLabelTextIcon2.setText(" ERROR EN LA OPERACIÓN!");
        ...
        rSLabelTextIcon2.setIcons(rojeru_san.efectos.ValoresEnum.ICONS.ERROR);

        btnAceptar.setBackground(new java.awt.Color(255, 255, 255));
        btnAceptar.setForeground(new java.awt.Color(255, 0, 0));
        btnAceptar.setText("Aceptar");
        btnAceptar.setToolTipText("");
        btnAceptar.setColorHover(new java.awt.Color(255, 102, 102));
        btnAceptar.setColorText(new java.awt.Color(255, 0, 0));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(rSLabelTextIcon2, javax.swing.GroupLayout.DEFAULT_SIZE, 344, Short.MAX_VALUE)
                .addContainerGap())
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DangerAlert.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DangerAlert().setVisible(true);
            }
        });
    }
