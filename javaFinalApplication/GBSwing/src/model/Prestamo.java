...
public class Prestamo {
    ...
    //Datos del modelo de tabla prestamo de BBDD
    String id;
    ...
    public String toString() {
        return "Prestamo{" + "id=" + id + ", nombre_estudiante=" + nombre_estudiante + ", apellido_estudiante=" + apellido_estudiante + ", dni_estudiante=" + dni_estudiante + ", curso_estudiante=" + curso_estudiante + ", division_estudiante=" + division_estudiante + ", titulo_libro=" + titulo_libro + ", edicion_libro=" + edicion_libro + ", isbn_libro=" + isbn_libro + ", autor_libro=" + autor_libro + ", editorial_libro=" + editorial_libro + ", fecha_prestamo=" + fecha_prestamo + '}';
    }
}
